...
public class Vendor
{
    ...
    public String getChangeString()
    {
        ...
        */
        Coins change = new Coins(price);

        String changeString= change.getQuarters() + " Quarters, " + change.getDimes() + " Dimes, " + change.getNickles() + " Nickles, and " + change.getPennies() + " Pennies";
